...
"""
This script downloads the pretrained models, and saves them in trained_networks/pretrained_baselines.
...
shutil.move("pretrained_baselines", "trained_networks/pretrained_baselines")
